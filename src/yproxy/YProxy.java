...
public class YProxy {
    ...
    private static void usage() {
        ...
        System.err.println(" --hostname        启动服务的地址，默认127.0.0.1");
        System.err.println(" --port            启动服务监听的端口，默认11400");
        System.err.println(" --readbuffersize  服务IO读缓冲字节大小，默认1024");
        System.err.println(" --writebuffersize 服务IO写缓冲字节大小，默认1024");
